        ...
        <div className="flex items-center">
          <div className="bg-indigo-600 p-1.5 md:p-2 rounded-lg mr-3 shadow-lg shadow-indigo-200">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v11.494m-9-5.747h18M5.468 12.012A9.004 9.004 0 0112 3.012a9.004 9.004 0 016.532 8.999 9.004 9.004 0 016.532 9.001 9.004 9.004 0 01-6.532-9" />
            </svg>
          </div>
          <div className="flex flex-col">
            <span className="text-[10px] font-black text-indigo-600 uppercase tracking-widest leading-none">AURA SKILL</span>
